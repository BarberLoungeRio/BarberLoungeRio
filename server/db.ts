...
const defaultContent: InsertSiteContent[] = [
  ...
  { key: "instagramSectionEyebrow", label: "Instagram · selo da seção", section: "instagram", value: "Barber Lounge no seu Feed", fieldType: "text" },
  ...
  { key: "instagramProfileDescription", label: "Instagram · descrição do perfil", section: "instagram", value: "O feed oficial é atualizado diretamente no Instagram. Abra o perfil para ver as publicações mais recentes, sem imagens demonstrativas ou conteúdo de outra fonte.", fieldType: "textarea" },
  ...
  { key: "heroRatingNumber", label: "Hero · avaliação número", section: "hero", value: "4,9 ★", fieldType: "text" },
  { key: "heroRatingLabel", label: "Hero · avaliação legenda", section: "hero", value: "Avaliação no Google", fieldType: "text" },
  ...
  { key: "instagramDescription", label: "Instagram · descrição", section: "instagram", value: "Bastidores, cortes e novidades direto da nossa cadeira para a sua tela.", fieldType: "textarea" },
